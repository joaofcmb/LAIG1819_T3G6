...
class Info extends CGFobject {
    ...
    displayTimer() {
        ...
        this.scene.pushMatrix();
            this.scene.translate(-1.3499, .1, 0.175);
        ...
        this.scene.pushMatrix();
            this.scene.translate(-1.3499, .1, 0.025);
            this.scene.scale(.075, .15, .075);
            this.scene.rotate(Math.PI / 2, 0, 1, 0);
        ...
        this.scene.pushMatrix();
            this.scene.translate(-1.3499, .1, -0.1);
        ...
        this.scene.pushMatrix();
            this.scene.translate(-1.3499, .1, -0.225);
            this.scene.scale(.075, .15, .075);
            this.scene.rotate(Math.PI / 2, 0, 1, 0);
        ...
        this.scene.pushMatrix();
            this.scene.translate(-1.3499, .1, -0.375);
            this.scene.scale(.075, .15, .075);
            this.scene.rotate(Math.PI / 2, 0, 1, 0);
